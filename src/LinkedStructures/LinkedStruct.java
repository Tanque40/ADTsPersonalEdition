...
public class LinkedStruct<T>{
     ...
     * @param pos int is the position on the structure for add
     * if pos <= 1, add in the position 1
     ...
     * @param pos int the position in the structure to remove.
     * if pos is out of range throws an ElementNotFoundException.
     */
     ...
     * @param pos int is the position of the element to return.
     * if pos is out of range throws an ElementNotFoundException.
     */
     ...
     * @param pos int the position for the element
     * if pos is out of range throws an ElementNotFoundException.
     */
     ...
     * @param info T is the element to serch and delete the previus element.
     * Return true if the action is correct, false if have problems to delete.
     * if info param is incorrectly throws a ParamErrorException. 
     */
     ...
     * @param info T the node to search.
     * Return true if the action is correct, false if have problems to delete.
     * if info param is incorrectly throws a ParamErrorException. 
     */
     ...
     * @param newest T is the new element to insert in the structure 
     * Return true if the action is correct, false if have problems to Insert.
     * if refer or newest param is incorrectly throws a ParamErrorException. 
     */
